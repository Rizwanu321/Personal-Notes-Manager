    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8 flex-col sm:flex-row">
          <h1 className="text-4xl sm:text-3xl md:text-4xl font-bold text-gray-800 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
            Your Notes
          </h1>
          <SearchBar
            search={search}
        ...
        {noNotesMessage ? (
          ...
          <div className="flex flex-wrap gap-6 justify-center">
            {filteredNotes.map((note) => (
              <div
                key={note._id}
                className="flex flex-col w-full sm:w-1/2 md:w-1/3 lg:w-1/4 bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200"
              >
